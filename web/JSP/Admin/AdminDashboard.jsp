    ...
    <div class="container-fluid left">
        <div class="col-md-12 left">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h4 class="h4 mb-0 text-gray-800">Hi, Admin</h4>
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs text-primary text-uppercase mb-1">
                                        ...
                                        <div class="h5 mb-0 font-weight-bold text-center text-gray-800 doc_cnt">0</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs text-primary text-uppercase mb-1">
                                        ...
                                        <div class="h5 mb-0 font-weight-bold text-center text-gray-800">0</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card border-left-primary shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs text-primary text-uppercase mb-1">
                                        <div class="h6 font-weight-bold text-center">Total Appointments(Today)</div>
                                        <div class="h5 mb-0 font-weight-bold text-center text-gray-800">0</div>
                                    </div>
                                </div>
                            </div>
